...
include_once('../dbConnection.php');
 ...
 $stuOcc = $row["stu_occ"];
 $stuImg = $row["stu_img"];
 $stu_email_verify = $row["stu_email_verify"];
 ...
 <div class="col-sm-6 mt-5">
  <form class="mx-5" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <?php if ($stu_email_verify == '0') { ?>
       <p style="color: red;">Email is not verified</p>
       <button type="button" class="btn btn-primary" onclick="sendverifiedemail('<?php echo $stuEmail; ?>')">Verify</button>
    <?php  } else { ?>
